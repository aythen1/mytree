...
const Bsqueda = () => {
  ...
  return (
    <View style={styles.bsqueda}>
      ...
      />
      <Pressable
        style={[styles.backParent, styles.headerFlexBox]}
      ...
      <View style={[styles.header, styles.headerFlexBox]}>
        <View style={[styles.searchBar, styles.headerFlexBox]}>
          ...
          <View style={styles.placeholderInput}>
            <Text style={styles.search}>{message.name}</Text>
          </View>
        </View>
        ...
        <View style={[styles.frameParent, styles.textPosition]}>
          <View style={styles.frameGroup}>
            ...
            <View style={styles.brunoPhamParent}>
              <Text style={styles.brunoPham}>{message.name}</Text>
              <Text style={styles.vendrnLuegoA}>{message.message}</Text>
            </View>
          </View>
