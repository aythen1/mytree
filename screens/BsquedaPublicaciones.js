...
const BsquedaPublicaciones = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.bsquedaPublicaciones, styles.iconLayout]}>
      <Image
        style={[styles.navigationIcon, styles.headerLayout]}
        contentFit="cover"
        source={require("../assets/navigation10.png")}
      />
      <View style={[styles.bsquedaPublicacionesChild, styles.headerLayout]} />
      <Image
      ...
      <View style={[styles.tabsParent, styles.headerLayout]}>
        ...
        <View style={[styles.publicacionesWrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.publicaciones, styles.retosTypo]}>
            Publicaciones
          </Text>
        </View>
        <Pressable
      ...
      <View style={styles.image2Parent}>
        ...
        />
        <Text
          style={[styles.subeTusRecuerdos, styles.retosTypo]}
        >{`Sube tus recuerdos y mantente al día de todos
tus seres queridos, ¡no esperes más!`}</Text>
      </View>
    </View>
  );
};
...
export default BsquedaPublicaciones;
