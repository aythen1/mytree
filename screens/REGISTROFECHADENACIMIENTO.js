...
const REGISTROFECHADENACIMIENTO = () => {
      ...
      <View style={[styles.frameParent, styles.framePosition]}>
        <View style={styles.frameChildLayout}>
          ...
          <Text style={[styles.laVerdaderaRiqueza, styles.registrateTypo]}>
            La verdadera riqueza de la vida no se mide en posesiones, sino en la
            calidad de las relaciones familiares que construimos y mantenemos a
            lo largo del tiempo.
          </Text>
        </View>
...
export default REGISTROFECHADENACIMIENTO;
