    ...
    <>
      <View style={styles.miDiarioEntradaTextoPl}>
        ...
        <View style={styles.frameParent}>
          ...
          >
            <Text style={[styles.text, styles.textFlexBox]}>07</Text>
          ...
          <Text style={[styles.descubriendoElMundo, styles.textFlexBox]}>
            Descubriendo el mundo
          </Text>
          <Text
            style={[styles.hoyLoHe, styles.textFlexBox]}
...
🌞 El mejor momento del día fue...`}</Text>
        ...
        <Image
          style={[styles.image6Icon, styles.privacidadPosition]}
          contentFit="cover"
        ...
        <Image
          ...
          contentFit="cover"
          source={require('../assets/navigation24.png')}
        />
...
export default MIDIARIOENTRADATEXTOPL1
