      ...
      <View style={styles.frameParent}>
        <View>
          ...
          <View style={styles.maskGroupParent}>
            ...
            />
            <View style={styles.martnGarciaParent}>
              <Text style={styles.pendientes}>Martín Garcia</Text>
              <View
                style={[
                  styles.seleccionarParentescoParent,
                  styles.primoaMaternoaWrapperFlexBox,
                ]}
              >
        ...
        <View style={styles.frameContainer}>
          ...
          <View style={styles.maskGroupParent}>
            ...
            <View style={styles.martnGarciaParent}>
              ...
              <Text style={[styles.hermana, styles.hermanaTypo]}>Hermana</Text>
            </View>
          </View>
          <View style={styles.maskGroupParent}>
            <Image
            ...
            <View style={styles.martnGarciaParent}>
              ...
              <Text style={[styles.hermana, styles.hermanaTypo]}>Sobrino</Text>
            </View>
          </View>
        </View>
        <View style={styles.frameContainer}>
        ...
        <View style={styles.frameContainer}>
          ...
          <View style={styles.maskGroupParent}>
            ...
            <View style={styles.martnGarciaParent}>
              ...
              <View
                style={[
                  styles.primoaMaternoaWrapper,
                  styles.primoaMaternoaWrapperFlexBox,
                ]}
              >
                <Text style={styles.hermanaTypo}>Primo/a materno/a</Text>
              </View>
            </View>
          </View>
        </View>
