...
const MENSAJERA = () => {
  ...
  return (
    <View style={styles.mensajera}>
        ...
        <View>
          <Pressable onPress={() => navigation.navigate("Chat")}>
            ...
            <View style={[styles.frameContainer, styles.framePosition]}>
              ...
              <View style={styles.hace2FlexBox}>
          ...
          <View style={styles.rectangleGroup}>
            ...
            <View style={[styles.frameParent1, styles.frameLayout]}>
              <View style={styles.frameParent2}>
                ...
                <View style={styles.marieGarcaParent}>
                  <Text style={[styles.marieGarca, styles.brunoPhamTypo]}>
                    Marie García
                  </Text>
                  <View style={styles.vectorParent}>
                    ...
                    />
                    <Text style={[styles.valeNosVemos, styles.searchTypo]}>
                      Vale, nos vemos allá!
                    </Text>
                  </View>
                </View>
      ...
      <View style={[styles.mensajeraChild, styles.frameParent16Position]} />
      <Image
      ...
      <View style={[styles.frameParent16, styles.frameParent16Position]}>
        <View>
          <View style={styles.storiesLayout}>
            ...
            <View style={[styles.benjamin, styles.youLayout]}>
              ...
              />
              <View style={[styles.youWrapper, styles.aatarIconPosition]}>
                <Text style={[styles.benjamin1, styles.signTypo]}>
                  Benjamin
                </Text>
              </View>
            </View>
          ...
          <View style={[styles.buttonParent, styles.storiesLayout]}>
            <LinearGradient
      ...
      <Image
        style={[styles.navigationIcon, styles.frameParent16Position]}
        contentFit="cover"
        source={require("../assets/navigation11.png")}
      />
      <Pressable
        style={[styles.newMessage, styles.vectorIconPosition]}
        onPress={() => navigation.navigate("Bsqueda")}
      >
        <LinearGradient
