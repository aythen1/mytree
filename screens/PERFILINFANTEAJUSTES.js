...
const PERFILINFANTEAJUSTES = () => {
  ...
  return (
    <>
      <View style={[styles.perfilInfanteAjustes, styles.frameItemLayout]}>
        <View style={[styles.perfilInfanteAjustesInner, styles.backPosition]}>
          ...
          >
            ...
            />
            <Text style={[styles.embarazo, styles.embarazoTypo]}>Embarazo</Text>
            <Pressable
              style={[styles.frameParent, styles.frameParentFlexBox]}
        ...
        <Text style={[styles.ajustesDelInfante, styles.ajustesDelInfanteTypo]}>
          Ajustes del infante
        </Text>
        <Image
