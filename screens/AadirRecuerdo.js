...
const AadirRecuerdo = () => {
  ...
  return (
    <View style={[styles.aadirRecuerdo, styles.iconLayout]}>
      <Image
        ...
        <View style={styles.frameParent}>
          ...
          <View style={styles.frameContainer}>
            ...
            <View style={styles.frameParent1}>
              ...
              <View style={[styles.rectangleGroup, styles.frameChildShadowBox]}>
                <LinearGradient
              ...
              <View
                style={[styles.rectangleContainer, styles.frameChildShadowBox]}
              >
                <LinearGradient
                  style={styles.frameChildLayout}
                  locations={[0, 1]}
              ...
              <View style={styles.frameParent2}>
                <View
                  style={[styles.rectangleParent3, styles.frameChildShadowBox]}
                >
                  <LinearGradient
                    style={styles.frameChildLayout}
                    locations={[0, 1]}
                ...
                <View
                  style={[styles.rectangleParent4, styles.frameChildShadowBox]}
                >
                  <LinearGradient
                ...
                <View
                  style={[styles.rectangleParent5, styles.frameChildShadowBox]}
                >
                  <LinearGradient
                    style={styles.frameChildLayout}
                    locations={[0, 1]}
                ...
                <View
                  style={[styles.rectangleParent6, styles.frameChildShadowBox]}
                >
                  <LinearGradient
                    style={styles.frameChildLayout}
                    locations={[0, 1]}
                ...
                <View
                  style={[styles.rectangleParent7, styles.frameChildShadowBox]}
                >
                  <LinearGradient
                    style={styles.frameChildLayout}
                    locations={[0, 1]}
                  ...
                  />
                  <Text
                    style={[styles.normal, styles.edicinTypo]}
                  >{`B&N`}</Text>
                </View>
              </View>
            </View>
